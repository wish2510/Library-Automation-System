		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5>Add New Reader</h5>
					</div>
					<!-- end box / title -->
					<form id="form" action="<%=request.getContextPath() %>/Logincontroller" method="post">
					<input type = "hidden" value="AddNewReader" name="flag">
					<div class="form">
						<div class="fields">
							<div class="field  field-first">
								...
								<div class="input">
									<input type="text" id="input-small" name="Name" class="small" />
									
								</div>
							</div>
							<div class="field">
								<div class="label">
									<label for="input-medium">Address:</label>
								</div>	
								<div class="input">
									<input type="text" id="input-medium" name="Address" class="medium" />
								</div>
							</div>
							<div class="field">
								<div class="label">
								...
								<div class="input">
									<input type="text" id="input-large" name="Phone" class="large" />
								</div>
							</div>
							<div class="buttons">
