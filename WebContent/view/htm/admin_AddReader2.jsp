...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%
		...
		List branchlist = branchajaxdao.select();
		
		authorVO authorVO = new authorVO();
		authorajaxdao authorajaxdao = new authorajaxdao();
		List authorlist = authorajaxdao.select();
	...
	<body>
		...
		<div id="header">
			...
			<!-- user -->
			<ul id="user">
				<li class="first"><a href="">Hello (${sessionScope.Lls1.username})</a></li>
		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<!-- end box / title -->
					<form id="form" action="<%=request.getContextPath() %>/Logincontroller2" method="post">
					...
					<div class="form">
						<div class="fields">
							...
							<div class="field">
								...
								<div class="input">
										<select name="branchretrived" id="authorret"  style="min-width:57%;height: 30px" required>
											<option value="">--select--</option>
											<c:forEach items="<%=branchlist%>" var="row">
												<option value="${row.branchID}" id="${row.branchID }">(${row.branchName})  (ID: ${row.branchID})</option>
											</c:forEach>
										</select>
								</div>
							</div>
							...
							<div class="field">
								<div class="label">
									<label for="input-large">Book Title:</label>
								</div>
								<div class="input">
									<input type="text" id="input-large" name="booktitle" class="large" />
								</div>
							</div>
							...
							<div class="field">
								...
								<div class="input">
										<select name="authorretrived" id="authorret"  style="min-width:57%;height: 30px" required>
											<option value="">--select--</option>
							...
							<div class="field">
								...
								<div class="input">
										<select name="publisherretrived" id="authorret"  style="min-width:57%;height: 30px" required>
											<option value="">--select--</option>
											<c:forEach items="<%=publisherlist%>" var="row">
												<option value="${row.publisherID}" id="${row.publisherID }">(${row.publisherName})  (ID: ${row.publisherID})</option>
											</c:forEach>
										</select>
								</div>
							</div>
							...
							<div class="field">
								<div class="label">
									<label for="input-large">Publication Date:</label>
								</div>
								<div class="input">
									<input type="text" id="input-large" name="pubDate" class="large" />
								</div>
							</div>
							<div class="field">
								<div class="label">
								...
								<div class="input">
									<input type="text" id="input-large" name="isbn" class="large" />
								</div>
							</div><div class="field">
								<div class="label">
									<label for="input-large">No of copy:</label>
								</div>
								<div class="input">
									<input type="text" id="input-large" name="numcopy" class="large" />
								</div>
							</div>
