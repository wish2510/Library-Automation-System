		...
		<div id="content">
			...
			<div id="right">
				...
				<div class="box">
					...
					<input type = "hidden" value="searchbypublisher" name="flag">
					<div class="form">
							<div class="fields">
							<div class="field  field-first">
								<div class="label">
									<label for="input-small">Publisher Name</label>
								</div>
								<div class="input">
									<input type="text" id="input-medium" name="searchbypub" class="medium" />
								</div>
							</div>
